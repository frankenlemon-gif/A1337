...
Duress Password — a phone data reset code, configurable in this app, that you enter via this keyboard in the lock screen password input field, instead of an ordinary password, and send by pressing the Enter arrow (⏎) when someone forces you to unlock the phone.
